...
int    tmstps = 4096,                 // The number of timesteps per period.
	   plts   = 1024;                 // Number of plots per period.

const char*  CO_filename = "gvPA_4096.dat";   // Input flow file at the heart.
...
const char*  PL_filename = "zero.dat";       // Outflow (Static pressure) file.
...
double conv   = 1333.220,             // Conversion from mmHg to SI-units.
       ...
       Tper   = 0.70,                 // The period of one heart beat [s].
